...
// The first character indicates the major and the second is a number character 1, 2, 3, or 4, 
// which indicates whether a student is a freshman, sophomore, junior, or senior. Suppose that the following characters are used to denote the majors:
